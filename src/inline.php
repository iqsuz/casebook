        ...
        <div class="container-fluid">
            <div class="col-xl-8 col-md-10 col-sm-12 col-xs-12 mx-auto defect-registration">
                <form method="POST" action="create_case.php" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row my-3">
                        <div class="col-4">
                            <label class="label-text" for="body_no">SEQ</label>
                            <input type="text" class="form-control" id="seq" name="seq" placeholder="####" maxlength="6" required>
                            <small class="text-muted">Required</small>
                        </div>
                        <div class="col-8">
                            <label class="label-text" for="body_no">Body No</label>
                            <input type="text" class="form-control" id="body_no" name="body_no" placeholder="######" maxlength="6">
                    ...
                    <div class="row my-3">
                        <div class="col-12">
                            <label class="label-text" for="o_place">Station</label>
                            <input type="text" class="form-control" id="o_place" name="o_place" placeholder="e.g. CP-26" maxlength="20" required>
                            <small class="text-muted">Required</small>
                        </div>
                    </div>
                    ...
                    <div class="row my-3">
                        <div class="col-12">
                            <label class="label-text" for="responsible">Responsible</label>
                            <input type="text" class="form-control" id="responsible" name="responsible" placeholder="e.g. Supplier" maxlength="20">
                            <small class="text-muted">Optional</small>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="house" value="M" id="house">
